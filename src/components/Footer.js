      ...
      <div className="footer-section">
        <div className="info-text-row">
          ...
          <div className="info-text-wrapper">
            ...
            <div className="info-text-2">ssupernova</div>
          </div>
          <div className="info-text-wrapper">
        ...
        <div className="info-text-row">
          ...
          <div className="info-text-wrapper">
            ...
            <div className="info-text-2">ssupernova(csy5271abcd@gmail.com)</div>
          </div>
          <div className="info-text-wrapper">
            <div className="info-text-1">입금계좌</div>
            <div className="info-text-2">신한은행 000-000-000000</div>
          </div>
        </div>
      </div>
    </div>
